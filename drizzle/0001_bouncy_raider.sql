...
CREATE UNIQUE INDEX "user_provider_preferences_user_provider_idx" ON "user_provider_preferences" USING btree ("user_id","provider_connection_id");--> statement-breakpoint
CREATE UNIQUE INDEX "user_provider_preferences_user_default_idx" ON "user_provider_preferences" USING btree ("user_id","is_default") WHERE "user_provider_preferences"."is_default" = true;--> statement-breakpoint
...
CREATE INDEX "chat_sessions_user_updated_at_idx" ON "chat_sessions" USING btree ("user_id","updated_at");--> statement-breakpoint
